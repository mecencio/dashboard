...
if (isset($_SESSION['usuario'])){
    if ($_SESSION['usuario']->getRol() != "BARTENDER") {
        ...
        <section class="bar__pedidos container">
            ...
            <div class="card my-3 text-center w-50 mx-auto row">
                ...
                <div class="card-body">
                    ...
                    <a href="bar.php?id=<?php echo $pedido["id"] ?>" class="btn btn-outline-primary">Entregado</a>
                </div>
                </div>
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination justify-content-center">
                ...
                <!-- PHP de adentro: setea la página previa restándole 5 al dato pasado por GET (Si existiera). Son 5 por la cantidad de registros por pag -->
                    <a class="page-link" href="bar.php?inicio=<?php echo isset($_GET["inicio"])?$_GET["inicio"]-5:0; ?>" aria-label="Previous">
                ...
                ?>
                    ...
                    <li class="page-item paginas">
                        <a class="page-link <?php echo (isset($_GET["inicio"]) && $_GET["inicio"] == (5*($i-1)))? 'pagina-activa':''; ?><?php echo (!isset($_GET["inicio"]) && $i == 1)? 'pagina-activa':''; ?>" href="bar.php?inicio=<?php echo (5*($i-1)) ?>">
                            <?php echo $i ?>
                        </a>
                    </li>
                <?php
                ...
                <li class="page-item <?php echo ((isset($_GET["inicio"]) && ($_GET["inicio"] != (5*($paginas-1)))) || ($paginas == 1))? 'disabled':''; ?>">
                    ...
                    <a class="page-link" href="bar.php?inicio=<?php echo isset($_GET["inicio"])?$_GET["inicio"]+5:5; ?>" aria-label="Next">
